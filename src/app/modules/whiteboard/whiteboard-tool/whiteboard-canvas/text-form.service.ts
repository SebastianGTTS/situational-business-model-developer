...
export class TextFormService implements OnDestroy {
  ...
  textForm: UntypedFormGroup = this.fb.group({
  ...
  private get boldControl(): UntypedFormControl {
    return this.textForm.get('bold') as UntypedFormControl;
  }

  private get italicControl(): UntypedFormControl {
    return this.textForm.get('italic') as UntypedFormControl;
  }

  private get underlineControl(): UntypedFormControl {
    return this.textForm.get('underline') as UntypedFormControl;
  }

  private get strikethroughControl(): UntypedFormControl {
    return this.textForm.get('strikethrough') as UntypedFormControl;
  }
}
