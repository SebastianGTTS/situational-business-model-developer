...
import { ExperimentAddModal } from '../experiment/experiment-add-modal/experiment-add-modal';
...
import { ExperimentDeleteModal } from '../experiment/experiment-delete-modal/experiment-delete-modal';
...
import { ExperimentEvidenceCostsModal } from '../experiment/experiment-evidence-costs-modal/experiment-evidence-costs-modal';
...
import { HypothesisMappingsModal } from '../hypothesis/hypothesis-mappings-modal/hypothesis-mappings-modal';
import { ExperimentMappingsModalComponent } from '../experiment/experiment-mappings-modal/experiment-mappings-modal.component';
import { ExperimentMappingsModal } from '../experiment/experiment-mappings-modal/experiment-mappings-modal';
import { ArtifactsShowModalComponent } from '../experiment/artifacts-show-modal/artifacts-show-modal.component';
import { ArtifactsShowModal } from '../experiment/artifacts-show-modal/artifacts-show-modal';
...
export function ExperimentsEditMixin<T extends Constructor<MixinOnLoaded>>(
    ...
    implements ExperimentsEditMixin
  {
    ...
    async addMapping(mapping: UntypedFormGroup): Promise<void> {
      if (this.hypoMoMapTree != null && this.hypoMoMap != null) {
        try {
