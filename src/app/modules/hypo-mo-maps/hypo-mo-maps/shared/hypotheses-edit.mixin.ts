...
import { HypothesisModal } from '../hypothesis-modal/hypothesis-modal';
...
import { HypothesisDeleteModal } from '../hypothesis-delete-modal/hypothesis-delete-modal';
...
export interface HypothesesEditMixin {
  ...
  addHypothesis(hypothesis: FormGroup): Promise<void>;
...
export function HypothesesEditMixin<T extends Constructor<MixinOnLoaded>>(
  ...
  abstract class HypothesesEditor extends Base implements HypothesesEditMixin {
    ...
    async addHypothesis(hypothesis: FormGroup): Promise<void> {
