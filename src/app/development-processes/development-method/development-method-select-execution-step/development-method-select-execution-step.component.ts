  ...
  implements OnInit, OnChanges, OnDestroy
{
      ...
      .pipe(
        ...
        tap(() =>
          this.executionStepsFormService.executionStepMethodChange(
            this.formGroup.parent as UntypedFormArray,
            this.stepNumber
          )
        ),
  ...
  get moduleControl(): UntypedFormControl {
    return this.formGroup.get('module') as UntypedFormControl;
  }
  ...
  get outputArtifactsControl(): UntypedFormArray {
    return this.formGroup.get('outputMappings') as UntypedFormArray;
  }

  get predefinedInputControl(): UntypedFormGroup {
    return this.formGroup.get('predefinedInput') as UntypedFormGroup;
  }
