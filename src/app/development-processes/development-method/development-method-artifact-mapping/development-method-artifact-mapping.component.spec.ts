...
describe('DevelopmentMethodArtifactMappingComponent', () => {
  ...
  const createHost = createHostFactory({
    ...
    providers: [
      ...
      ExecutionStepsFormService,
      mockProvider(MetaArtifactService),
  ...
  describe('default', () => {
    const defaultMetaArtifact: Readonly<MetaArtifactIdentifier> = {
      type: 'Test Type',
      name: 'Test Model',
    };
        ...
        [
          {
            ...
            description: '',
            input: [],
            output: [defaultMetaArtifact],
          },
          {
            name: 'refineCanvas',
            description: '',
            input: [defaultMetaArtifact],
            output: [defaultMetaArtifact],
          },
        ],
        {
    ...
    beforeEach(() => {
      ...
      spectator.hostComponent.metaArtifact = defaultMetaArtifact;
    ...
    it('should create', () => {
      ...
      expect(spectator.query('#inputArtifact-0')).toHaveSelectedOptions(
        spectator.query(
          byText('#1 ' + defaultMetaArtifact.name)
                ...
                items: [
                  {
                    element: new Artifact(undefined, {
                      ...
                      list: 'Default List',
                      metaArtifact: defaultMetaArtifact,
